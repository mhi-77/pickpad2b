...
import { Search, Calculator, ListChecks, FileText, Settings, Menu, X, CheckCheck, User } from 'lucide-react';
import { useAuth } from '../context/AuthContext';

const menuItems = [
  { id: 'search', label: 'Búsqueda', icon: Search },
  { id: 'stats', label: 'Estadísticas', icon: Calculator },
  { id: 'fiscalizar', label: 'Fiscalizar', icon: ListChecks },
  { id: 'gusers', label: 'Usuarios', icon: User },
