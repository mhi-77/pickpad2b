      ...
      <div className="bg-white rounded-2xl shadow-xl p-6 w-full max-w-md">
        ...
        */}
        ...
        <button
            ...
            aria-label="Ver instrucciones para instalar la aplicación"
            className="mt-6 w-full flex items-center justify-center gap-2 py-2.5 px-4 rounded-lg border border-blue-200 bg-blue-50 text-blue-600 hover:bg-blue-100                             transition-colors text-sm font-medium min-h-[44px]"
          >
