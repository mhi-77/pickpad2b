      ...
      <div className="bg-white rounded-xl shadow-lg p-3">
        <div className="flex flex-wrap items-center justify-between gap-2 mb-4">
          <div>
            ...
            <p className={`text-sm ${isRealtime ? 'text-gray-700' : 'text-gray-700'}`}>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-2 flex flex-col">
                ...
                <p className="text-sm text-blue-700 mt-1 text-left">Total Empadronados</p>
              </div>
              <div className="bg-slate-50 border border-slate-200 rounded-lg p-2 flex flex-col">
                <div className="flex items-center space-x-3">
                  <SmartphoneNfc className="w-8 h-8 text-slate-600 shrink-0" />
                  <p className="text-2xl font-bold text-slate-900">{formatNumber(stats.mesasActivas)}</p>
                </div>
                <p className="text-sm text-slate-700 mt-1 text-left">Mesas Activas</p>
              </div>
              <div className="bg-green-50 border border-green-200 rounded-lg p-2 flex flex-col">
                <div className="flex items-center space-x-3">
                  <CheckCircle className="w-8 h-8 text-green-600 shrink-0" />
                  <p className="text-2xl font-bold text-green-900">{formatNumber(stats.totalVotosEmitidos)}</p>
                </div>
                <p className="text-sm text-green-700 mt-1 text-left">Votos Emitidos</p>
              </div>
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-2 flex flex-col">
                <div className="flex items-center space-x-3">
                  <PieChart className="w-8 h-8 text-yellow-600 shrink-0" />
                  <p className="text-2xl font-bold text-yellow-900">{stats.porcentajeParticipacion.toLocaleString()}%</p>
                </div>
                <p className="text-sm text-yellow-700 mt-1 text-left">Participación General</p>
              </div>
            </div>
